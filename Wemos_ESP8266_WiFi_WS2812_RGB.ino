...
#define CANDLEPIXELS 6      //This is how may led's will represent your 'wick'. With a 60 LED strip, 30 gives the effect of a tealight or small candle when in an opaque container.
...
// via lokale WIFI netwerk 
const char *ssid = "pelikaan";         // de WIFI access point waarmee verbonden moet worden.       
const char *password = "8270000928";   // het WIFI wachtwoord. 
MDNSResponder mdns;

boolean conn = WiFi.softAP(AP_NameChar, WiFiPassword); // Wemos als wifi Access Point webserver met adrres http://192.168.4.1    
...
void setup ( void ) {
	...
	Serial.begin ( 115200 );             // als de Wemos met de computer verbonden is kun je in de Arduino IDE de terminal starten om te zien welk ip-adres de Wemos krijgt. 
